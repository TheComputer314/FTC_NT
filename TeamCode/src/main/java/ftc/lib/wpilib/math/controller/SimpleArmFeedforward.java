...
package ftc.lib.wpilib.math.controller;

/**
 * A helper class that computes feedforward outputs for a simple arm (modeled as a motor acting
 * against the force of gravity on a beam suspended at an angle).
 */
public class SimpleArmFeedforward {
   ...
   */
  public SimpleArmFeedforward(double ks, double kg, double kv, double ka) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
   ...
   * @param kv The velocity gain.
   */
  public SimpleArmFeedforward(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
